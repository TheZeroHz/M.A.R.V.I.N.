...
#define TFT_MOSI 2      //if 46(instant fry your board)// In some display driver board, it might be written as "SDA" and so on.
#define TFT_SCLK 20
#define TFT_CS   19     // Chip select control pin
#define TFT_DC   9  // Data Command cosntrol pin
